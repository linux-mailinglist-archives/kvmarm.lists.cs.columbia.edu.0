...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id 45256376088
	for <lists+kvmarm@lfdr.de>; Fri,  7 May 2021 08:41:27 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id ED1DC4B57D;
	Fri,  7 May 2021 02:41:26 -0400 (EDT)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id LVzw+z-WefvH; Fri,  7 May 2021 02:41:25 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 8215A4B559;
	Fri,  7 May 2021 02:41:25 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 20E374B28B
 for <kvmarm@lists.cs.columbia.edu>; Fri,  7 May 2021 02:41:24 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id iscfMQ4+pDw8 for <kvmarm@lists.cs.columbia.edu>;
 Fri,  7 May 2021 02:41:22 -0400 (EDT)
Received: from us-smtp-delivery-124.mimecast.com
 (us-smtp-delivery-124.mimecast.com [170.10.133.124])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id B53C14B491
 for <kvmarm@lists.cs.columbia.edu>; Fri,  7 May 2021 02:41:22 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1620369682;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:mime-version:mime-version:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding:
 in-reply-to:in-reply-to:references:references;
 bh=0YgR1Zn0/Vd4AChO9HLa5uHlWX48jG9nG92OqHX5K74=;
 b=MyBZoskCeOHHezo1ppgU5kDT69LNHwlk4z8+bwpVHCnq5ZAYks1lK9RJI3oyfj3/JDFvSw
 Rp8l11bMExob2kstMWranGPyvFVcBwhLAKOivEkMljlqZKDB2Fa+PNomiC0B/ll31MK5gG
 B18aJmMGiz9xvKKTPdzigeF3A51d6aU=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-468-fBoqjWNOOMOa2pGUErizBw-1; Fri, 07 May 2021 02:41:20 -0400
X-MC-Unique: fBoqjWNOOMOa2pGUErizBw-1
Received: from smtp.corp.redhat.com (int-mx06.intmail.prod.int.phx2.redhat.com
 [10.5.11.16])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id AB981107ACE4;
 Fri,  7 May 2021 06:41:19 +0000 (UTC)
Received: from gshan.redhat.com (vpn2-54-42.bne.redhat.com [10.64.54.42])
 by smtp.corp.redhat.com (Postfix) with ESMTP id BEF2D5C276;
 Fri,  7 May 2021 06:41:16 +0000 (UTC)
From: Gavin Shan <gshan@redhat.com>
To: kvmarm@lists.cs.columbia.edu
Subject: [PATCH v3 07/15] KVM: arm64: Support page-not-present notification
Date: Fri,  7 May 2021 16:40:45 +0800
Message-Id: <20210507084053.44407-8-gshan@redhat.com>
...
index 822781f94cb0..e241a93c6485 100644
--- a/arch/arm64/include/asm/kvm_host.h
+++ b/arch/arm64/include/asm/kvm_host.h
@@ -272,6 +272,31 @@ struct vcpu_reset_state {
 	bool		reset;
 };
...
+
 struct kvm_vcpu_arch {
 	...
 	void *sve_state;
@@ -376,6 +401,7 @@ struct kvm_vcpu_arch {
 	} steal;
...
@@ -731,6 +757,30 @@ int kvm_arm_vcpu_arch_get_attr(struct kvm_vcpu *vcpu,
...
index 695dbefb3a3c..6bb3ec03cce5 100644
...
index 2b8035fc7b47..a9f9f53aaeee 100644
--- a/arch/arm64/kvm/mmu.c
+++ b/arch/arm64/kvm/mmu.c
@@ -844,6 +844,33 @@ static inline bool is_write_fault(unsigned int esr)
...
@@ -959,8 +986,10 @@ int kvm_handle_user_mem_abort(struct kvm_vcpu *vcpu,
 	 */
 	smp_rmb();
