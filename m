...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id C476952D449
	for <lists+kvmarm@lfdr.de>; Thu, 19 May 2022 15:43:34 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 71CC24B32E;
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id 13Dru+B-9SRR; Thu, 19 May 2022 09:43:34 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 406824B38D;
	Thu, 19 May 2022 09:43:32 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 63E0A4B348
 for <kvmarm@lists.cs.columbia.edu>; Thu, 19 May 2022 09:43:31 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 6ddmMvgyn3sf for <kvmarm@lists.cs.columbia.edu>;
 Thu, 19 May 2022 09:43:29 -0400 (EDT)
Received: from sin.source.kernel.org (sin.source.kernel.org [145.40.73.55])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id CABBA4B37F
 for <kvmarm@lists.cs.columbia.edu>; Thu, 19 May 2022 09:43:28 -0400 (EDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by sin.source.kernel.org (Postfix) with ESMTPS id 7B36BCE238E;
 Thu, 19 May 2022 13:43:26 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 2739AC385AA;
 Thu, 19 May 2022 13:43:20 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1652967804;
 bh=4N4bcwyFZJoL+b/ml2TlF/N5TGi04swBT24h71w3TjA=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: Will Deacon <will@kernel.org>
To: kvmarm@lists.cs.columbia.edu
Subject: [PATCH 15/89] KVM: arm64: Introduce shadow VM state at EL2
Date: Thu, 19 May 2022 14:40:50 +0100
Message-Id: <20220519134204.5379-16-will@kernel.org>
...
index 000000000000..dc06b043bd83
--- /dev/null
...
index 5e2197db0d32..8e51cdab00b7 100644
...
@@ -175,6 +176,24 @@ static void handle___pkvm_vcpu_init_traps(struct kvm_cpu_context *host_ctxt)
...
@@ -204,6 +223,8 @@ static const hcall_t host_hcall[] = {
...
index 1262dbae7f06..502bc0d04858 100644
...
index 311197a223e6..e9e146e50254 100644
...
+
 	...
 	if (!hyp_pgt_base)
@@ -265,6 +272,7 @@ void __noreturn __pkvm_init_finalise(void)
 	if (ret)
 		goto out;
