...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id B3CBF23359D
	for <lists+kvmarm@lfdr.de>; Thu, 30 Jul 2020 17:35:06 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 60CC54B1CF;
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id P71tteifR6Xy; Thu, 30 Jul 2020 11:35:03 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id F2CFA4B520;
	Thu, 30 Jul 2020 11:35:01 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id E36CF4B3AB
 for <kvmarm@lists.cs.columbia.edu>; Thu, 30 Jul 2020 11:35:00 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id zkxOAMYnRmLi for <kvmarm@lists.cs.columbia.edu>;
 Thu, 30 Jul 2020 11:34:58 -0400 (EDT)
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id CA9E74B42C
 for <kvmarm@lists.cs.columbia.edu>; Thu, 30 Jul 2020 11:34:56 -0400 (EDT)
Received: from localhost.localdomain (236.31.169.217.in-addr.arpa
 [217.169.31.236])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 336DB208A9;
 Thu, 30 Jul 2020 15:34:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1596123296;
 bh=tZ8vS/y1YX9gaqcbctoeYX2ybtKONJA5HNu6F8tiTok=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=uExHKOwcBTzYpa8qTaudWAMozwg/6eF0IrIBu1izm1/yTGJJG7Zyfg/HDxbVyJvYf
 eh/cSblS89bCsQKRcnfCQv49aYPTtxm/TGfTOI9zc0SnR+ikLA6XePp2n4PVoKocGi
 v6Xuz9wXAO9raC9jVufMXMRAWqPjv9BCkcFhKTcI=
From: Will Deacon <will@kernel.org>
To: kvmarm@lists.cs.columbia.edu
Subject: [PATCH 18/20] KVM: arm64: Remove unused page-table code
Date: Thu, 30 Jul 2020 16:34:04 +0100
Message-Id: <20200730153406.25136-19-will@kernel.org>
...
---
 ...
 arch/arm64/kvm/mmu.c                    | 764 ------------------------
 5 files changed, 1150 deletions(-)

diff --git a/arch/arm64/include/asm/kvm_mmu.h b/arch/arm64/include/asm/kvm_mmu.h
index e4bdaf58340f..0dbd97260eea 100644
--- a/arch/arm64/include/asm/kvm_mmu.h
+++ b/arch/arm64/include/asm/kvm_mmu.h
@@ -137,123 +137,6 @@ void kvm_mmu_free_memory_caches(struct kvm_vcpu *vcpu);
...
@@ -295,30 +178,6 @@ static inline void __invalidate_icache_guest_page(kvm_pfn_t pfn,
 	}
 }
...
index 56d2d9fc84ae..3779564a29ef 100644
...
index 4b8234a35f5a..66af9c00b9ad 100644
...
@@ -81,75 +74,11 @@ void kvm_flush_remote_tlbs(struct kvm *kvm)
...
-
 ...
 {
@@ -177,94 +106,6 @@ void kvm_mmu_free_memory_caches(struct kvm_vcpu *vcpu)
...
-
  ...
  *
@@ -289,108 +130,6 @@ static inline void kvm_pgd_populate(pgd_t *pgdp, p4d_t *p4dp)
...
-
  ...
  * @kvm:   The VM pointer
@@ -415,71 +154,6 @@ static void unmap_stage2_range(struct kvm_s2_mmu *mmu, phys_addr_t start, u64 si
...
-
 ...
 {
@@ -815,348 +489,6 @@ void kvm_free_stage2_pgd(struct kvm_s2_mmu *mmu)
...
-
  ...
  *
@@ -1194,102 +526,6 @@ int kvm_phys_addr_ioremap(struct kvm *kvm, phys_addr_t guest_ipa,
 	return ret;
 }
