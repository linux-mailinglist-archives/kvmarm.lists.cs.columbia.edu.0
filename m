...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id A5163610C94
	for <lists+kvmarm@lfdr.de>; Fri, 28 Oct 2022 11:00:06 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id CE2074141A;
	Fri, 28 Oct 2022 05:00:05 -0400 (EDT)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id KdC38YQCSv4y; Fri, 28 Oct 2022 05:00:05 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 74BE940E62;
	Fri, 28 Oct 2022 04:59:56 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 9AF8840417
 for <kvmarm@lists.cs.columbia.edu>; Fri, 28 Oct 2022 04:59:54 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id xQcMipMKq3UU for <kvmarm@lists.cs.columbia.edu>;
 Fri, 28 Oct 2022 04:59:45 -0400 (EDT)
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id 8CC6940307
 for <kvmarm@lists.cs.columbia.edu>; Fri, 28 Oct 2022 04:59:44 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666947584; x=1698483584;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=TvJBhm/uz0cfLGi2iBCDhCveo4eh5OLTXwVquLyMf6A=;
 b=imZf2OOSN9VLj932ksi5hMxyWDNm9OopyyaEiyEqqoGT6l5fD5UwgtP1
 uMqwZjOt2WcWp3YwmQgL0y8CFsTYuRldEgDXWouCrCsZWRI9IN4FqVSHQ
 P7Q5EhSXgASHnwU2qQ4LMPq/FT4F7OcnCLM/Flr9tLIhHsRBeL2U5OznI
 GbSG4eFO1H5WUh0JxYgfJ5s77vg6D8Fga2xV1qm5aN2jeUSx4JiTdevrl
 A7QUKwA9PC3eGQoRePV9jwpGR+nCRycS8gtaOe1VO0KV+nCZwngtDderE
 kBjcqn8YWb7vMLmJPNAnjMtQiEhdQzmf/g71wwfCiarTyXGUnTBxQNhnI A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="370499985"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="370499985"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2022 00:37:35 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="775287523"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="775287523"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
 by fmsmga001.fm.intel.com with ESMTP; 28 Oct 2022 00:37:30 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1ooJvg-0009dj-1F;
 Fri, 28 Oct 2022 07:37:24 +0000
Date: Fri, 28 Oct 2022 15:36:51 +0800
From: kernel test robot <lkp@intel.com>
To: Oliver Upton <oliver.upton@linux.dev>, Marc Zyngier <maz@kernel.org>,
 James Morse <james.morse@arm.com>,
 Alexandru Elisei <alexandru.elisei@arm.com>
Subject: Re: [PATCH v3 08/15] KVM: arm64: Protect stage-2 traversal with RCU
Message-ID: <202210281527.aFQcynFa-lkp@intel.com>
References: <20221027221752.1683510-9-oliver.upton@linux.dev>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="lFc60x0aIANd8Ny/"
...
patch link:    https://lore.kernel.org/r/20221027221752.1683510-9-oliver.upton%40linux.dev
patch subject: [PATCH v3 08/15] KVM: arm64: Protect stage-2 traversal with RCU
...
reproduce:
        ...
        # https://github.com/intel-lab-lkp/linux/commit/aa16a7f1a37320ca39f3e58ece728c3c2ee67d76
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Oliver-Upton/KVM-arm64-Parallel-stage-2-fault-handling/20221028-062442
        git checkout aa16a7f1a37320ca39f3e58ece728c3c2ee67d76
...
>> arch/arm64/kvm/mmu.c:650:36: sparse: sparse: incorrect type in initializer (different address spaces) @@     expected unsigned long long [noderef] [usertype] __rcu *[usertype] pgd @@     got unsigned long long [usertype] * @@
   arch/arm64/kvm/mmu.c:650:36: sparse:     expected unsigned long long [noderef] [usertype] __rcu *[usertype] pgd
   arch/arm64/kvm/mmu.c:650:36: sparse:     got unsigned long long [usertype] *

vim +650 arch/arm64/kvm/mmu.c

6011cf68c88545 Marc Zyngier 2021-07-26  646  
6011cf68c88545 Marc Zyngier 2021-07-26  647  static int get_user_mapping_size(struct kvm *kvm, u64 addr)
6011cf68c88545 Marc Zyngier 2021-07-26  648  {
6011cf68c88545 Marc Zyngier 2021-07-26  649  	struct kvm_pgtable pgt = {
6011cf68c88545 Marc Zyngier 2021-07-26 @650  		.pgd		= (kvm_pte_t *)kvm->mm->pgd,
6011cf68c88545 Marc Zyngier 2021-07-26  651  		.ia_bits	= VA_BITS,
6011cf68c88545 Marc Zyngier 2021-07-26  652  		.start_level	= (KVM_PGTABLE_MAX_LEVELS -
6011cf68c88545 Marc Zyngier 2021-07-26  653  				   CONFIG_PGTABLE_LEVELS),
6011cf68c88545 Marc Zyngier 2021-07-26  654  		.mm_ops		= &kvm_user_mm_ops,
6011cf68c88545 Marc Zyngier 2021-07-26  655  	};
6011cf68c88545 Marc Zyngier 2021-07-26  656  	kvm_pte_t pte = 0;	/* Keep GCC quiet... */
6011cf68c88545 Marc Zyngier 2021-07-26  657  	u32 level = ~0;
6011cf68c88545 Marc Zyngier 2021-07-26  658  	int ret;
6011cf68c88545 Marc Zyngier 2021-07-26  659  
6011cf68c88545 Marc Zyngier 2021-07-26  660  	ret = kvm_pgtable_get_leaf(&pgt, addr, &pte, &level);
6011cf68c88545 Marc Zyngier 2021-07-26  661  	VM_BUG_ON(ret);
6011cf68c88545 Marc Zyngier 2021-07-26  662  	VM_BUG_ON(level >= KVM_PGTABLE_MAX_LEVELS);
6011cf68c88545 Marc Zyngier 2021-07-26  663  	VM_BUG_ON(!(pte & PTE_VALID));
6011cf68c88545 Marc Zyngier 2021-07-26  664  
6011cf68c88545 Marc Zyngier 2021-07-26  665  	return BIT(ARM64_HW_PGTABLE_LEVEL_SHIFT(level));
6011cf68c88545 Marc Zyngier 2021-07-26  666  }
6011cf68c88545 Marc Zyngier 2021-07-26  667  
