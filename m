...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id B44E25E8F77
	for <lists+kvmarm@lfdr.de>; Sat, 24 Sep 2022 21:11:20 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id F21984B76C;
	Sat, 24 Sep 2022 15:11:19 -0400 (EDT)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id T61AV+jBjtjO; Sat, 24 Sep 2022 15:11:19 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 793534B6F0;
	Sat, 24 Sep 2022 15:11:10 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 25FBE40E25
 for <kvmarm@lists.cs.columbia.edu>; Sat, 24 Sep 2022 15:11:09 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id oRWZNMkFhlpy for <kvmarm@lists.cs.columbia.edu>;
 Sat, 24 Sep 2022 15:10:59 -0400 (EDT)
Received: from mga04.intel.com (mga04.intel.com [192.55.52.120])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id 6B95B40DF4
 for <kvmarm@lists.cs.columbia.edu>; Sat, 24 Sep 2022 15:10:58 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1664046658; x=1695582658;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=2sG2hL1KvtJ2pbf5+XpLnUBIvstmFme2EHTLTwQyjLM=;
 b=kFvFVaTQhxkvq62gc662z1CSDXm5TjPp8KrEE7oPDgvK2ONhLbDCZmfn
 nQXQRmrEXwhrzrMwokTVcVJGxvZdtlxTfxhNrUO5wbTxoX00qYGBD0ZOl
 6q+nfNRuLzG8wfLNss0YFR11pwD2ar/qBFXcm6uUOcTy+s8RVVDZpzEUu
 6LGgPKKzYG0IvVC98DpoPoHpaabUu65JXNk0Vq1Rjn/6EQFywoH7Jp4HY
 NXvZGioqqPBMBSTwS8EX/8i1a3xOGkQ2KgnvBza9UoUsaU8cd0acS01wQ
 VfRLgVf6nk7JnCQtrw2JBOTLfC4QeGg0p1dzoG0AtKaaqrtr0H05vdmHN Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10480"; a="299524845"
X-IronPort-AV: E=Sophos;i="5.93,342,1654585200"; d="scan'208";a="299524845"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
 by fmsmga104.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 24 Sep 2022 12:10:56 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,342,1654585200"; d="scan'208";a="746165836"
Received: from lkp-server01.sh.intel.com (HELO c0a60f19fe7e) ([10.239.97.150])
 by orsmga004.jf.intel.com with ESMTP; 24 Sep 2022 12:10:51 -0700
Received: from kbuild by c0a60f19fe7e with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1ocAY6-0006to-1V;
 Sat, 24 Sep 2022 19:10:50 +0000
Date: Sun, 25 Sep 2022 03:10:30 +0800
From: kernel test robot <lkp@intel.com>
To: Will Deacon <will@kernel.org>, kvmarm@lists.cs.columbia.edu
Subject: Re: [PATCH v3 14/25] KVM: arm64: Add per-cpu fixmap infrastructure
 at EL2
Message-ID: <202209250250.fczWyvVH-lkp@intel.com>
References: <20220914083500.5118-15-will@kernel.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="uXg/9O/Sg76UL4S6"
Content-Disposition: inline
In-Reply-To: <20220914083500.5118-15-will@kernel.org>
...
[also build test ERROR on linus/master next-20220923]
[cannot apply to arm64/for-next/core]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Will-Deacon/KVM-arm64-Introduce-pKVM-hyp-VM-and-vCPU-state-at-EL2/20220914-164007
base:    80e78fcce86de0288793a0ef0f6acf37656ee4cf
config: arm64-randconfig-s053-20220923
...
reproduce:
        ...
        # https://github.com/intel-lab-lkp/linux/commit/1b331dc8141e012614bd97cd7d2846801c5e51f4
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Will-Deacon/KVM-arm64-Introduce-pKVM-hyp-VM-and-vCPU-state-at-EL2/20220914-164007
        git checkout 1b331dc8141e012614bd97cd7d2846801c5e51f4
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross C=1 CF='-fdiagnostic-prefix -D__CHECK_ENDIAN__' O=build_dir ARCH=arm64 SHELL=/bin/bash arch/arm64/ sound/
...
All errors (new ones prefixed by >>):
   ...
   In function 'kvm_phys_to_pte',
       inlined from 'hyp_fixmap_map' at arch/arm64/kvm/hyp/nvhe/mm.c:228:10:
>> include/linux/compiler_types.h:354:45: error: call to '__compiletime_assert_416' declared with attribute error: FIELD_PREP: value too large for the field
   ...
   include/linux/bitfield.h:114:17: note: in expansion of macro '__BF_FIELD_CHECK'
     114 |                 __BF_FIELD_CHECK(_mask, 0ULL, _val, "FIELD_PREP: ");    \
         |                 ^~~~~~~~~~~~~~~~
   arch/arm64/include/asm/kvm_pgtable.h:55:24: note: in expansion of macro 'FIELD_PREP'
      55 |                 pte |= FIELD_PREP(KVM_PTE_ADDR_51_48, pa >> 48);
         |                        ^~~~~~~~~~


vim +/__compiletime_assert_416 +354 include/linux/compiler_types.h
...
# Linux/arm64 6.0.0-rc5 Kernel Configuration
#
