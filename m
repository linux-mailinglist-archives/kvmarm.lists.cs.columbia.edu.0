...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id 18B52114FC7
	for <lists+kvmarm@lfdr.de>; Fri,  6 Dec 2019 12:31:37 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 92A7E4AF5C;
	Fri,  6 Dec 2019 06:31:36 -0500 (EST)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id rZBXRHynDcQf; Fri,  6 Dec 2019 06:31:36 -0500 (EST)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 14FAB4AF44;
	Fri,  6 Dec 2019 06:31:27 -0500 (EST)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 1D9614AF12
 for <kvmarm@lists.cs.columbia.edu>; Fri,  6 Dec 2019 06:31:26 -0500 (EST)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id t3kogNS-VZnd for <kvmarm@lists.cs.columbia.edu>;
 Fri,  6 Dec 2019 06:31:16 -0500 (EST)
Received: from us-smtp-1.mimecast.com (us-smtp-1.mimecast.com [207.211.31.81])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id B951C4AE94
 for <kvmarm@lists.cs.columbia.edu>; Fri,  6 Dec 2019 06:31:16 -0500 (EST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
 s=mimecast20190719; t=1575631876;
 h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
 to:to:cc:cc:content-type:content-type:
 content-transfer-encoding:content-transfer-encoding;
 bh=vKYXpNKcJ8EbLsar96MWBJYdHzIb1fFQWZ9sajO3oHM=;
 b=E990MJK2XJZDUaOYnj2Eq3nXnrmAeHcr3RcE85d4j+j2sdYKlWGOBQn7RAQzV/rxzQaf/l
 5YU+8hWH7bE/gKrnQxP0ZpCy9oKM1ZQnxRV5K/c++iAQ4hrXPT8Xf/OPuWxPsrGQOVHobp
 Pdu0lL4PWr7VQ2h46cTFkGWcbrJUaTA=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-159-QgZ7RIOYPPCbsX9q05_MMg-1; Fri, 06 Dec 2019 06:31:13 -0500
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.phx2.redhat.com
 [10.5.11.11])
 (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
 (No client certificate requested)
 by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 4628F107ACC9;
 Fri,  6 Dec 2019 11:31:12 +0000 (UTC)
Received: from thuth.com (ovpn-116-205.ams2.redhat.com [10.36.116.205])
 by smtp.corp.redhat.com (Postfix) with ESMTP id 46BE260161;
 Fri,  6 Dec 2019 11:31:06 +0000 (UTC)
From: Thomas Huth <thuth@redhat.com>
To: kvm@vger.kernel.org,
	Paolo Bonzini <pbonzini@redhat.com>
Subject: [kvm-unit-tests v3 PATCH] Switch the order of the parameters in
 report() and report_xfail()
Date: Fri,  6 Dec 2019 12:31:02 +0100
Message-Id: <20191206113102.14914-1-thuth@redhat.com>
X-Scanned-By: MIMEDefang 2.79 on 10.5.11.11
X-MC-Unique: QgZ7RIOYPPCbsX9q05_MMg-1
...
---
 v3: Fixed a new report() in x86/vmx_tests.c
 ...
 x86/vmx_tests.c           | 631 ++++++++++++++++++++------------------
 x86/xsave.c               |  80 ++---
 67 files changed, 1189 insertions(+), 1111 deletions(-)
...
@@ -9131,8 +9165,9 @@ static void rdtsc_vmexit_diff_test(void)
...
@@ -9158,12 +9193,12 @@ static int invalid_msr_init(struct vmcs *vmcs)
...
@@ -9173,7 +9208,7 @@ static int invalid_msr_entry_failure(struct vmentry_failure *failure)
 	ulong reason;
...
@@ -9274,12 +9309,12 @@ static void atomic_switch_msrs_test(int count)
