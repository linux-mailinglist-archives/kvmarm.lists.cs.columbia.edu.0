...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id A17BB5F82A0
	for <lists+kvmarm@lfdr.de>; Sat,  8 Oct 2022 05:02:49 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 8F9B44B0F4;
	Fri,  7 Oct 2022 23:02:48 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
X-Spam-Flag: NO
X-Spam-Score: -1.788
X-Spam-Level: 
X-Spam-Status: No, score=-1.788 required=6.1 tests=[BAYES_00=-1.9,
	DKIM_SIGNED=0.1, T_DKIM_INVALID=0.01, UPPERCASE_75_100=0.001,
	URIBL_BLOCKED=0.001] autolearn=unavailable
Authentication-Results: mm01.cs.columbia.edu (amavisd-new); dkim=softfail
	(fail, message has been altered) header.i=@intel.com
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id 2wWhOhAVDAoI; Fri,  7 Oct 2022 23:02:48 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 28D014B0C2;
	Fri,  7 Oct 2022 23:02:39 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id A57EE49F01
 for <kvmarm@lists.cs.columbia.edu>; Fri,  7 Oct 2022 23:02:37 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id iiyegfsk8tni for <kvmarm@lists.cs.columbia.edu>;
 Fri,  7 Oct 2022 23:02:28 -0400 (EDT)
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id CCDEA40CDE
 for <kvmarm@lists.cs.columbia.edu>; Fri,  7 Oct 2022 23:02:27 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1665198147; x=1696734147;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=DCJ/4Gif5p8FMGVdM//KmxmMKfjk82zU000Z79TlAvM=;
 b=IdDWc1DokqAlGn5JmHTtRPOgSpaprrlgF4FfLq6Qh5J7Vvs3gB9n2c/6
 z3G31GjTxi4KiE6IvSy0hoBtfDiUnwdC3bbBzzTX8SYfG0mzVQvstXG6c
 Or2/z8WVOZ80Oabxt6Jw/atWVNjF9Cz+IpsKC4tACRsMIryLQYx/UCnEP
 BDH6D9n5pxk/wVoeru3yzkuawuBOjP6XCX2JYQSJ5S3x9/rvy0RQHRJ42
 kd9pq9n9akOwtYd3DLS67psLsxRMLilDgs6d6MNXePkobKwZfMnRREIt/
 kChuTZNH3LKzZT3BOvFDlJQgdb9i49iTBfNqi/9VUDUQ7cY/fxmp8W2KW w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10493"; a="301487658"
X-IronPort-AV: E=Sophos;i="5.95,168,1661842800"; d="scan'208";a="301487658"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
 by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 07 Oct 2022 20:02:26 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10493"; a="688126904"
X-IronPort-AV: E=Sophos;i="5.95,168,1661842800"; d="scan'208";a="688126904"
Received: from lkp-server01.sh.intel.com (HELO 3c15167049b7) ([10.239.97.150])
 by fmsmga008.fm.intel.com with ESMTP; 07 Oct 2022 20:02:21 -0700
Received: from kbuild by 3c15167049b7 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1oh06W-0001m1-1d;
 Sat, 08 Oct 2022 03:02:20 +0000
Date: Sat, 8 Oct 2022 11:01:44 +0800
From: kernel test robot <lkp@intel.com>
To: Oliver Upton <oliver.upton@linux.dev>, Marc Zyngier <maz@kernel.org>,
 James Morse <james.morse@arm.com>,
 Alexandru Elisei <alexandru.elisei@arm.com>
Subject: Re: [PATCH v2 15/15] KVM: arm64: Handle stage-2 faults in parallel
Message-ID: <202210081008.A9PLyQx2-lkp@intel.com>
References: <20221007233253.460257-1-oliver.upton@linux.dev>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ISWps2m9vf7owvmZ"
Content-Disposition: inline
In-Reply-To: <20221007233253.460257-1-oliver.upton@linux.dev>
Cc: kbuild-all@lists.01.org, kvm@vger.kernel.org, kvmarm@lists.linux.dev,
...
[auto build test WARNING on b302ca52ba8235ff0e18c0fa1fa92b51784aef6a]

url:    https://github.com/intel-lab-lkp/linux/commits/Oliver-Upton/KVM-arm64-Parallel-stage-2-fault-handling/20221008-073516
base:   b302ca52ba8235ff0e18c0fa1fa92b51784aef6a
config: arm64-allyesconfig
compiler: aarch64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/816539cc5d9b9779875740ddad602312def40ed6
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Oliver-Upton/KVM-arm64-Parallel-stage-2-fault-handling/20221008-073516
        git checkout 816539cc5d9b9779875740ddad602312def40ed6
...
vim +260 arch/arm64/kvm/hyp/nvhe/mem_protect.c

   255	
   256	static inline int __host_stage2_idmap(u64 start, u64 end,
   257					      enum kvm_pgtable_prot prot)
   258	{
   259		return kvm_pgtable_stage2_map(&host_kvm.pgt, start, end - start, start,
 > 260					      prot, &host_s2_pool, false);
   261	}
   262	
