...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id 2891D454A33
	for <lists+kvmarm@lfdr.de>; Wed, 17 Nov 2021 16:42:23 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id BA1884B22C;
	Wed, 17 Nov 2021 10:42:22 -0500 (EST)
X-Virus-Scanned: at lists.cs.columbia.edu
X-Spam-Flag: NO
X-Spam-Score: -1.402
X-Spam-Level: 
X-Spam-Status: No, score=-1.402 required=6.1 tests=[BAYES_00=-1.9,
	DNS_FROM_AHBL_RHSBL=2.699, FUZZY_XPILL=2.799, RCVD_IN_DNSWL_HI=-5]
	autolearn=unavailable
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
	with ESMTP id ONUEvniPeBVH; Wed, 17 Nov 2021 10:42:19 -0500 (EST)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id A07B64B234;
	Wed, 17 Nov 2021 10:42:19 -0500 (EST)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id CF4264B14C
 for <kvmarm@lists.cs.columbia.edu>; Wed, 17 Nov 2021 10:42:17 -0500 (EST)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id iZeWHjGh2GDa for <kvmarm@lists.cs.columbia.edu>;
 Wed, 17 Nov 2021 10:42:15 -0500 (EST)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 2EF5D4B1D5
 for <kvmarm@lists.cs.columbia.edu>; Wed, 17 Nov 2021 10:42:14 -0500 (EST)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 92A96ED1;
 Wed, 17 Nov 2021 07:42:13 -0800 (PST)
Received: from monolith.localdoman (unknown [172.31.20.19])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 963943F5A1;
 Wed, 17 Nov 2021 07:42:10 -0800 (PST)
From: Alexandru Elisei <alexandru.elisei@arm.com>
To: will@kernel.org, julien.thierry.kdev@gmail.com, maz@kernel.org,
 kvm@vger.kernel.org, kvmarm@lists.cs.columbia.edu
Subject: [RFC PATCH v5 kvmtool 1/4] update_headers: Sync KVM UAPI headers with
 KVM SPE implementation
Date: Wed, 17 Nov 2021 15:43:53 +0000
Message-Id: <20211117154356.303039-2-alexandru.elisei@arm.com>
...
index 5e3f12d5359e..6f63b0f4017d 100644
...
@@ -996,6 +1098,41 @@ struct kvm_ppc_resize_hpt {
...
@@ -1069,6 +1206,11 @@ struct kvm_x86_mce {
 #endif
...
+
 struct kvm_xen_hvm_config {
 	__u32 flags;
 	__u32 msr;
@@ -1086,7 +1228,7 @@ struct kvm_xen_hvm_config {
  *
...
@@ -1102,11 +1244,16 @@ struct kvm_irqfd {
...
+	__u32 pad[4];
 ...
 /* For KVM_CAP_SW_TLB */
@@ -1142,6 +1289,7 @@ struct kvm_dirty_tlb {
...
@@ -1222,6 +1370,8 @@ enum kvm_device_type {
...
@@ -1332,6 +1482,15 @@ struct kvm_s390_ucas_mapping {
...
@@ -1450,12 +1609,109 @@ struct kvm_enc_region {
...
@@ -1484,6 +1740,10 @@ enum sev_cmd_id {
 	KVM_SEV_DBG_ENCRYPT,
...
@@ -1536,6 +1796,51 @@ struct kvm_sev_dbg {
 	__u32 len;
 };
...
@@ -1606,4 +1911,133 @@ struct kvm_hyperv_eventfd {
