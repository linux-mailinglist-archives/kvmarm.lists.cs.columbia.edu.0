...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id 74708610E41
	for <lists+kvmarm@lfdr.de>; Fri, 28 Oct 2022 12:19:00 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id A9EA149EFA;
	Fri, 28 Oct 2022 06:18:59 -0400 (EDT)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id e-EsDtU-SOYq; Fri, 28 Oct 2022 06:18:59 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 38E4E40E62;
	Fri, 28 Oct 2022 06:18:50 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 3505840D02
 for <kvmarm@lists.cs.columbia.edu>; Fri, 28 Oct 2022 06:18:48 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id e2TgXKDTM79t for <kvmarm@lists.cs.columbia.edu>;
 Fri, 28 Oct 2022 06:18:39 -0400 (EDT)
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id BCAA3405C1
 for <kvmarm@lists.cs.columbia.edu>; Fri, 28 Oct 2022 06:18:38 -0400 (EDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
 d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
 t=1666952318; x=1698488318;
 h=date:from:to:cc:subject:message-id:references:
 mime-version:in-reply-to;
 bh=wuh6JwIhi43LuM+6zUVqvDwp0zQliY//Mf+8QtOvNSI=;
 b=Ns4jObNOtPWaG0PMGwFeql7YLeVNhssgNIuiJyGW0CglBDjwJfRmtHzd
 pbCQ93n+l7u0tGFqro2e9+xOCbCvaJWDAArqQ0stKvfFlS7g/cZXX4xhV
 tNPo/jpIN42gUNYbTKc7tbkN06RQdG0JTZOxh3loEtN2F+nYxsj0MDEXl
 V7Y74o2DyolTPeO/nEt7Kg1G+52lqW2wqsgh2yY+a0OqZOoyqMwSGGZq/
 ZuE9ocVrNy0Km4efkO4Ln07E4hcosn07ZwJ7YfroRMLmelLQNkTadPbKA
 NDMLyX1gtFZXPh9ZAGLu4RgfxdSsXvQGtCQEtsf222JBHTciywaQl4+Rn Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="288855099"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="288855099"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
 by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384;
 28 Oct 2022 03:18:37 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10513"; a="775327928"
X-IronPort-AV: E=Sophos;i="5.95,220,1661842800"; d="scan'208";a="775327928"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
 by fmsmga001.fm.intel.com with ESMTP; 28 Oct 2022 03:18:32 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
 (envelope-from <lkp@intel.com>) id 1ooMRc-0009nX-0d;
 Fri, 28 Oct 2022 10:18:32 +0000
Date: Fri, 28 Oct 2022 18:18:24 +0800
From: kernel test robot <lkp@intel.com>
To: Oliver Upton <oliver.upton@linux.dev>, Marc Zyngier <maz@kernel.org>,
 James Morse <james.morse@arm.com>,
 Alexandru Elisei <alexandru.elisei@arm.com>
Subject: Re: [PATCH v3 10/15] KVM: arm64: Atomically update stage 2 leaf
 attributes in parallel walks
Message-ID: <202210281807.yloNUgdW-lkp@intel.com>
References: <20221027222208.1684910-1-oliver.upton@linux.dev>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="PyBi4G3cs9JNKQB6"
Content-Disposition: inline
In-Reply-To: <20221027222208.1684910-1-oliver.upton@linux.dev>
...
url:    https://github.com/intel-lab-lkp/linux/commits/Oliver-Upton/KVM-arm64-Parallel-stage-2-fault-handling/20221028-062442
base:   247f34f7b80357943234f93f247a1ae6b6c3a740
patch link:    https://lore.kernel.org/r/20221027222208.1684910-1-oliver.upton%40linux.dev
patch subject: [PATCH v3 10/15] KVM: arm64: Atomically update stage 2 leaf attributes in parallel walks
config: arm64-randconfig-s053-20221026
...
reproduce:
        ...
        # https://github.com/intel-lab-lkp/linux/commit/ec2fa18019bd1c74a0c418df00872dbf3dc5a91e
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Oliver-Upton/KVM-arm64-Parallel-stage-2-fault-handling/20221028-062442
        git checkout ec2fa18019bd1c74a0c418df00872dbf3dc5a91e
...
>> arch/arm64/kvm/hyp/pgtable.c:556:34: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected void *addr @@     got unsigned long long [noderef] [usertype] __rcu *[usertype] pgd @@
   arch/arm64/kvm/hyp/pgtable.c:556:34: sparse:     expected void *addr
   arch/arm64/kvm/hyp/pgtable.c:556:34: sparse:     got unsigned long long [noderef] [usertype] __rcu *[usertype] pgd
   arch/arm64/kvm/hyp/pgtable.c:1184:42: sparse: sparse: incorrect type in argument 1 (different address spaces) @@     expected void *addr @@     got unsigned long long [noderef] [usertype] __rcu *[usertype] pgd @@
   arch/arm64/kvm/hyp/pgtable.c:1184:42: sparse:     expected void *addr
   arch/arm64/kvm/hyp/pgtable.c:1184:42: sparse:     got unsigned long long [noderef] [usertype] __rcu *[usertype] pgd
>> arch/arm64/kvm/hyp/pgtable.c:1208:9: sparse: sparse: incorrect type in argument 3 (different address spaces) @@     expected unsigned long long [noderef] [usertype] __rcu *[usertype] pgtable @@     got unsigned long long [usertype] *ptep @@
   arch/arm64/kvm/hyp/pgtable.c:1208:9: sparse:     expected unsigned long long [noderef] [usertype] __rcu *[usertype] pgtable
   arch/arm64/kvm/hyp/pgtable.c:1208:9: sparse:     got unsigned long long [usertype] *ptep

vim +556 arch/arm64/kvm/hyp/pgtable.c

bb0e92cbbcd1f9 Will Deacon    2020-09-11  547  
bb0e92cbbcd1f9 Will Deacon    2020-09-11  548  void kvm_pgtable_hyp_destroy(struct kvm_pgtable *pgt)
bb0e92cbbcd1f9 Will Deacon    2020-09-11  549  {
bb0e92cbbcd1f9 Will Deacon    2020-09-11  550  	struct kvm_pgtable_walker walker = {
bb0e92cbbcd1f9 Will Deacon    2020-09-11  551  		.cb	= hyp_free_walker,
2ea2ff91e82293 Quentin Perret 2021-12-15  552  		.flags	= KVM_PGTABLE_WALK_LEAF | KVM_PGTABLE_WALK_TABLE_POST,
bb0e92cbbcd1f9 Will Deacon    2020-09-11  553  	};
bb0e92cbbcd1f9 Will Deacon    2020-09-11  554  
bb0e92cbbcd1f9 Will Deacon    2020-09-11  555  	WARN_ON(kvm_pgtable_walk(pgt, 0, BIT(pgt->ia_bits), &walker));
7aef0cbcdcd099 Quentin Perret 2021-03-19 @556  	pgt->mm_ops->put_page(pgt->pgd);
bb0e92cbbcd1f9 Will Deacon    2020-09-11  557  	pgt->pgd = NULL;
bb0e92cbbcd1f9 Will Deacon    2020-09-11  558  }
71233d05f4b5e3 Will Deacon    2020-09-11  559  
