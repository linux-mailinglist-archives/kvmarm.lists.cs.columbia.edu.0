...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id DCD60535172
	for <lists+kvmarm@lfdr.de>; Thu, 26 May 2022 17:31:15 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 494714B2A4;
	Thu, 26 May 2022 11:31:15 -0400 (EDT)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id Wx2I1Paqne29; Thu, 26 May 2022 11:31:15 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 2FDA84B298;
	Thu, 26 May 2022 11:31:06 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id EB16649EDF
 for <kvmarm@lists.cs.columbia.edu>; Thu, 26 May 2022 11:31:04 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 6oJB8bV95-aT for <kvmarm@lists.cs.columbia.edu>;
 Thu, 26 May 2022 11:30:55 -0400 (EDT)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id CDBDD49EF0
 for <kvmarm@lists.cs.columbia.edu>; Thu, 26 May 2022 11:30:54 -0400 (EDT)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 2344A150C;
 Thu, 26 May 2022 08:30:54 -0700 (PDT)
Received: from monolith.localdoman (unknown [172.31.20.19])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 56AEA3F66F;
 Thu, 26 May 2022 08:30:51 -0700 (PDT)
...
Subject: [PATCH kvmtool 1/2] Add libfdt library
Date: Thu, 26 May 2022 16:30:57 +0100
Message-Id: <20220526153058.123290-2-alexandru.elisei@arm.com>
...
Get rid of all this overhead by adding the libfdt library to kvmtool. The
library is built only when an architecture requires it.

libfdt has been pulled from DTC commit ed310803ea89 ("pylibfdt: add
FdtRo.get_path()"). The changes to the kvmtool Makefile have been
heavily inspired by the DTC Makefile. No changes have been done to the
libfdt Makefile to allow easy updating in the future by copying the
updated files.
...
---
 ...
 20 files changed, 6032 insertions(+), 13 deletions(-)
...
index 6464446a9f24..c93b66a091e6 100644
--- a/Makefile
+++ b/Makefile
@@ -5,6 +5,7 @@
 ifeq ($(strip $(V)),)
...
@@ -347,15 +348,26 @@ $(warning No static libc found. Skipping guest init)
 	NOTFOUND        += static-libc
 endif
 
+LIBFDT_dir = libfdt
+LIBFDT_archive = $(LIBFDT_dir)/libfdt.a
+# kvmtool is Linux only.
+SHAREDLIB_EXT = so
+LIBFDT_lib = $(LIBFDT_dir)/$(LIBFDT_LIB)
+LIBFDT_include = $(addprefix $(LIBFDT_dir)/,$(LIBFDT_INCLUDES))
+# Change the version when libfdt is updated.
+DTC_VERSION = 1.6.1
+LIBFDT_version = $(addprefix $(LIBFDT_dir)/,$(LIBFDT_VERSION))
+
+LIBFDT_LDFLAGS = -fPIC -shared -Wl,--version-script=$(LIBFDT_version) -Wl,-soname,
+
...
@@ -428,18 +442,27 @@ STATIC_OBJS = $(patsubst %.o,%.static.o,$(OBJS) $(OBJS_STATOPT))
...
+$(PROGRAM): $(OBJS) $(OBJS_DYNOPT) $(OTHEROBJS) $(GUEST_OBJS) $(LIBFDT_DYNOBJS)
 	$(E) "  LINK    " $@
-	$(Q) $(CC) $(CFLAGS) $(OBJS) $(OBJS_DYNOPT) $(OTHEROBJS) $(GUEST_OBJS) $(LDFLAGS) $(LIBS) $(LIBS_DYNOPT) -o $@
+	$(Q) $(CC) $(CFLAGS) $(OBJS) $(OBJS_DYNOPT) $(OTHEROBJS) $(GUEST_OBJS) $(LDFLAGS) $(LIBS) $(LIBS_DYNOPT) $(LIBFDT_DYNOBJS) -o $@
...
+	@$(E) "  LD      " $@
+	$(Q) $(CC) $(LDFLAGS) $(LIBFDT_LDFLAGS)$(LIBFDT_soname) -o $(LIBFDT_lib) \
...
+$(LIBFDT_dir)/%.o: CFLAGS += -fPIC
 
 #
 # BIOS assembly weirdness
@@ -538,7 +562,7 @@ install: all
...
+libfdt_clean: STD_CLEANFILES = *.o libfdt.a $(LIBFDT_LIB)
+
 KVM_DEV	?= /dev/kvm
