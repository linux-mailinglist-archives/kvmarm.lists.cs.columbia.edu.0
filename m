...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id 79EA64621A0
	for <lists+kvmarm@lfdr.de>; Mon, 29 Nov 2021 21:07:41 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 1BE284B225;
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id CSoxIBr5znG0; Mon, 29 Nov 2021 15:07:41 -0500 (EST)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id BB3014B207;
	Mon, 29 Nov 2021 15:07:38 -0500 (EST)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id BF2D64B1F3
 for <kvmarm@lists.cs.columbia.edu>; Mon, 29 Nov 2021 15:07:36 -0500 (EST)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id UfdX8AXTWWu4 for <kvmarm@lists.cs.columbia.edu>;
 Mon, 29 Nov 2021 15:07:34 -0500 (EST)
Received: from sin.source.kernel.org (sin.source.kernel.org [145.40.73.55])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id C91694B191
 for <kvmarm@lists.cs.columbia.edu>; Mon, 29 Nov 2021 15:07:33 -0500 (EST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by sin.source.kernel.org (Postfix) with ESMTPS id 0FEBDCE13D8;
 Mon, 29 Nov 2021 20:07:31 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F1F4BC53FAD;
 Mon, 29 Nov 2021 20:07:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=k20201202; t=1638216449;
 bh=8cdoFre0JzsPC1BQ92v3Ji0LSjERCSUVm5O2TBaSd3w=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
Received: from sofa.misterjones.org ([185.219.108.64] helo=why.lan)
 by disco-boy.misterjones.org with esmtpsa (TLS1.3) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <maz@kernel.org>)
 id 1mrmrA-008gvR-Q8; Mon, 29 Nov 2021 20:02:32 +0000
From: Marc Zyngier <maz@kernel.org>
To: linux-arm-kernel@lists.infradead.org, kvmarm@lists.cs.columbia.edu,
 kvm@vger.kernel.org
Subject: [PATCH v5 51/69] KVM: arm64: nv: Nested GICv3 Support
Date: Mon, 29 Nov 2021 20:01:32 +0000
Message-Id: <20211129200150.351436-52-maz@kernel.org>
...
index 94d8814b7c8b..1664430be698 100644
...
index 96edd6348bd1..323215873388 100644
...
index 8e19da1a07e1..399b19d3a64a 100644
...
index b04616bf1839..0bb46bce5ffb 100644
--- a/arch/arm64/kvm/arm.c
+++ b/arch/arm64/kvm/arm.c
@@ -715,6 +715,8 @@ static void check_vcpu_requests(struct kvm_vcpu *vcpu)
...
@@ -813,9 +815,16 @@ int kvm_arch_vcpu_ioctl_run(struct kvm_vcpu *vcpu)
 		if (!ret)
 			ret = 1;
...
index b7e10f6178b9..198169648c3c 100644
--- a/arch/arm64/kvm/nested.c
+++ b/arch/arm64/kvm/nested.c
@@ -592,6 +592,22 @@ void kvm_arch_flush_shadow_all(struct kvm *kvm)
...
index 4415b03aa278..55f3e94c24f1 100644
...
@@ -444,6 +446,19 @@ static bool access_actlr(struct kvm_vcpu *vcpu,
 	return true;
 }
...
@@ -459,6 +474,11 @@ static bool access_gic_sgi(struct kvm_vcpu *vcpu,
 	if (!p->is_write)
...
@@ -502,7 +522,13 @@ static bool access_gic_sre(struct kvm_vcpu *vcpu,
 	if (p->is_write)
...
@@ -1844,6 +1870,122 @@ static bool access_spsr_el2(struct kvm_vcpu *vcpu,
 	return true;
 }
...
@@ -2296,6 +2438,41 @@ static const struct sys_reg_desc sys_reg_descs[] = {
...
index 04f62c4b07fb..ae4d6489373d 100644
...
index 21d088e8597d..6503aa208c9f 100644
...
index 510122b68d8a..a0db49e6c781 100644
--- a/include/kvm/arm_vgic.h
+++ b/include/kvm/arm_vgic.h
@@ -325,6 +325,15 @@ struct vgic_cpu {
...
+
 	...
 	/*
@@ -382,6 +391,13 @@ void kvm_vgic_load(struct kvm_vcpu *vcpu);
...
@@ -426,4 +442,6 @@ int vgic_v4_load(struct kvm_vcpu *vcpu);
