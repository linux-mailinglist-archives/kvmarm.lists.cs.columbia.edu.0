...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id B905A1B45C2
	for <lists+kvmarm@lfdr.de>; Wed, 22 Apr 2020 15:01:39 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 6B5B94B18C;
	Wed, 22 Apr 2020 09:01:39 -0400 (EDT)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id Z2F-V9PEE7hw; Wed, 22 Apr 2020 09:01:39 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id F1D394B191;
	Wed, 22 Apr 2020 09:01:30 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 9BCD34B07F
 for <kvmarm@lists.cs.columbia.edu>; Wed, 22 Apr 2020 08:58:32 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id Ok8m-pqthMbJ for <kvmarm@lists.cs.columbia.edu>;
 Wed, 22 Apr 2020 08:58:30 -0400 (EDT)
Received: from out30-132.freemail.mail.aliyun.com
 (out30-132.freemail.mail.aliyun.com [115.124.30.132])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id 6CDFB4B15B
 for <kvmarm@lists.cs.columbia.edu>; Wed, 22 Apr 2020 08:58:29 -0400 (EDT)
X-Alimail-AntiSpam: AC=PASS; BC=-1|-1; BR=01201311R511e4; CH=green; DM=||false|;
 DS=||; FP=0|-1|-1|-1|0|-1|-1|-1; HT=e01e04357;
 MF=tianjia.zhang@linux.alibaba.com; NM=1; PH=DS; RN=37; SR=0;
 TI=SMTPD_---0TwKEIDQ_1587560295; 
Received: from localhost(mailfrom:tianjia.zhang@linux.alibaba.com
 fp:SMTPD_---0TwKEIDQ_1587560295) by smtp.aliyun-inc.com(127.0.0.1);
...
Subject: [PATCH v2 5/7] KVM: PPC: clean up redundant kvm_run parameters in
 assembly
