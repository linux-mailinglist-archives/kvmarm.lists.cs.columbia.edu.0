...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id 50614134A7C
	for <lists+kvmarm@lfdr.de>; Wed,  8 Jan 2020 19:32:29 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id DCAD74B0CB;
	Wed,  8 Jan 2020 13:32:28 -0500 (EST)
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id PdDgT2BeQEW6; Wed,  8 Jan 2020 13:32:28 -0500 (EST)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 08ED64B0B1;
	Wed,  8 Jan 2020 13:32:27 -0500 (EST)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id D9BC14B0B1
 for <kvmarm@lists.cs.columbia.edu>; Wed,  8 Jan 2020 13:32:25 -0500 (EST)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id 9Fu6fzzWeT16 for <kvmarm@lists.cs.columbia.edu>;
 Wed,  8 Jan 2020 13:32:23 -0500 (EST)
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id C09BB4AFEE
 for <kvmarm@lists.cs.columbia.edu>; Wed,  8 Jan 2020 13:32:23 -0500 (EST)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 56F5C1FB;
 Wed,  8 Jan 2020 10:32:23 -0800 (PST)
Received: from donnerap.arm.com (donnerap.cambridge.arm.com [10.1.197.44])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 217103F534;
 Wed,  8 Jan 2020 10:32:22 -0800 (PST)
From: Andre Przywara <andre.przywara@arm.com>
To: Will Deacon <will@kernel.org>,
 Julien Thierry <julien.thierry.kdev@gmail.com>
Subject: [PATCH kvmtool] Add emulation for CFI compatible flash memory
Date: Wed,  8 Jan 2020 18:32:12 +0000
Message-Id: <20200108183212.252810-1-andre.przywara@arm.com>
...
+		case READ_ARRAY:
+			read_flash(sfdev, faddr, data, len);
+			return;
+		case READ_STATUS:
+			cfi_value = sfdev->sr;
+			break;
