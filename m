...
Received: from mm01.cs.columbia.edu (mm01.cs.columbia.edu [128.59.11.253])
	by mail.lfdr.de (Postfix) with ESMTP id A6502266038
	for <lists+kvmarm@lfdr.de>; Fri, 11 Sep 2020 15:26:31 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 514504B442;
...
Received: from mm01.cs.columbia.edu ([127.0.0.1])
	...
	with ESMTP id rvxUvRoRBzNL; Fri, 11 Sep 2020 09:26:31 -0400 (EDT)
Received: from mm01.cs.columbia.edu (localhost [127.0.0.1])
	by mm01.cs.columbia.edu (Postfix) with ESMTP id 8BFD64B33F;
	Fri, 11 Sep 2020 09:26:28 -0400 (EDT)
Received: from localhost (localhost [127.0.0.1])
 by mm01.cs.columbia.edu (Postfix) with ESMTP id 33B734B33F
 for <kvmarm@lists.cs.columbia.edu>; Fri, 11 Sep 2020 09:26:28 -0400 (EDT)
X-Virus-Scanned: at lists.cs.columbia.edu
Received: from mm01.cs.columbia.edu ([127.0.0.1])
 by localhost (mm01.cs.columbia.edu [127.0.0.1]) (amavisd-new, port 10024)
 with ESMTP id wjHFtmtop8Aq for <kvmarm@lists.cs.columbia.edu>;
 Fri, 11 Sep 2020 09:26:25 -0400 (EDT)
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
 by mm01.cs.columbia.edu (Postfix) with ESMTPS id BB4914B2B2
 for <kvmarm@lists.cs.columbia.edu>; Fri, 11 Sep 2020 09:26:24 -0400 (EDT)
Received: from localhost.localdomain (236.31.169.217.in-addr.arpa
 [217.169.31.236])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by mail.kernel.org (Postfix) with ESMTPSA id 8CD7A2222B;
 Fri, 11 Sep 2020 13:26:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
 s=default; t=1599830784;
 bh=alIAYFranOL7O8+MWCCSYRnUBsRamgqD9KHEjChTG7s=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=0NZUtHE9GZ+r4rJPyABV40fbTqwPCJ+VI3fGfVZj7dR3gFfBfZJVyqeNtgsPVfHdY
 RWX+lgpIqVwMFCIPAskUxGKcb2xU+CtC5ShJaiWVCb2isrq2+xCp5onoPC9Ossxetb
 rVfprFQhlm6Y8x6YUiy4MYULpvjjn7tOa81lOsU8=
From: Will Deacon <will@kernel.org>
To: kvmarm@lists.cs.columbia.edu
Subject: [PATCH v5 19/21] KVM: arm64: Remove unused page-table code
Date: Fri, 11 Sep 2020 14:25:27 +0100
Message-Id: <20200911132529.19844-20-will@kernel.org>
...
---
 ...
 5 files changed, 1172 deletions(-)

diff --git a/arch/arm64/include/asm/kvm_mmu.h b/arch/arm64/include/asm/kvm_mmu.h
index 42fb50cfe0d8..c490fe8089b3 100644
...
index 1a989353144e..2b5f822fb033 100644
...
index ed5aefd5d0a7..dd0ea7d8065a 100644
...
@@ -90,154 +83,11 @@ void kvm_flush_remote_tlbs(struct kvm *kvm)
...
-
  ...
  *
@@ -262,108 +112,6 @@ static inline void kvm_pgd_populate(pgd_t *pgdp, p4d_t *p4dp)
...
-
  ...
  * @kvm:   The VM pointer
@@ -392,71 +140,6 @@ static void unmap_stage2_range(struct kvm_s2_mmu *mmu, phys_addr_t start, u64 si
...
-
 ...
 {
@@ -805,348 +488,6 @@ void kvm_free_stage2_pgd(struct kvm_s2_mmu *mmu)
 	}
 }
...
-
  ...
  *
@@ -1189,102 +530,6 @@ int kvm_phys_addr_ioremap(struct kvm *kvm, phys_addr_t guest_ipa,
 	return ret;
 }
